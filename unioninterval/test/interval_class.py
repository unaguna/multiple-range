...
class TestSetRangeClass:
    ...
    @pytest.mark.parametrize('srange1, srange2, srange_m', (
        ...
        # 一方が単レンジでないパターン
        (interval(4, 6, '[]') + interval(8, 10, '[]'), interval(3, 5, '[]'), [interval(3, 6, '[]'), interval(8, 10, '[]')]),
        (interval(4, 6, '[)') + interval(8, 10, '[]'), interval(3, 5, '[]'), [interval(3, 6, '[)'), interval(8, 10, '[]')]),
        (interval(4, 6, '(]') + interval(8, 10, '[]'), interval(3, 5, '[]'), [interval(3, 6, '[]'), interval(8, 10, '[]')]),
        (interval(4, 6, '()') + interval(8, 10, '[]'), interval(3, 5, '[]'), [interval(3, 6, '[)'), interval(8, 10, '[]')]),
        (interval(4, 6, '[]') + interval(8, 10, '[]'), interval(3, 5, '[)'), [interval(3, 6, '[]'), interval(8, 10, '[]')]),
        ...
        (interval(4, 6, '[)') + interval(8, 10, '[]'), interval(6, 8, '[]'), interval(4, 10, '[]')),
        (interval(4, 6, '[)') + interval(8, 10, '[]'), interval(6, 8, '[)'), interval(4, 10, '[]')),
        (interval(4, 6, '[)') + interval(8, 10, '[]'), interval(6, 8, '(]'), [interval(4, 6, '[)'), interval(6, 10, '(]')]),
        (interval(4, 6, '[)') + interval(8, 10, '[]'), interval(6, 8, '()'), [interval(4, 6, '[)'), interval(6, 10, '(]')]),
        (interval(4, 6, '(]') + interval(8, 10, '[]'), interval(6, 8, '[]'), interval(4, 10, '(]')),
        (interval(4, 6, '(]') + interval(8, 10, '[]'), interval(6, 8, '[)'), interval(4, 10, '(]')),
        (interval(4, 6, '(]') + interval(8, 10, '[]'), interval(6, 8, '(]'), interval(4, 10, '(]')),
        ...
        (interval(4, 6, '()') + interval(8, 10, '[)'), interval(6, 8, '()'), [interval(4, 6, '()'), interval(6, 10, '()')]),
        (interval(4, 6, '[]') + interval(8, 10, '(]'), interval(6, 8, '[]'), interval(4, 10, '[]')),
        (interval(4, 6, '[]') + interval(8, 10, '(]'), interval(6, 8, '[)'), [interval(4, 8, '[)'), interval(8, 10, '(]')]),
        (interval(4, 6, '[]') + interval(8, 10, '(]'), interval(6, 8, '(]'), interval(4, 10, '[]')),
        (interval(4, 6, '[]') + interval(8, 10, '(]'), interval(6, 8, '()'), [interval(4, 8, '[)'), interval(8, 10, '(]')]),
        (interval(4, 6, '[)') + interval(8, 10, '(]'), interval(6, 8, '[]'), interval(4, 10, '[]')),
        (interval(4, 6, '[)') + interval(8, 10, '(]'), interval(6, 8, '[)'), [interval(4, 8, '[)'), interval(8, 10, '(]')]),
        ...
        (interval(4, 6, '[]') + interval(8, 10, '[]') + interval(12, 14, '[]'), interval(6, 12, '[]'), interval(4, 14, '[]')),
        # 双方が単レンジでないパターン
